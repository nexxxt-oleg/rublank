if (window){
    window.catalogEcommerceV2Small = {
        resizeVerticalBlock: function(){
            ...
            $('.bxr-ecommerce-v2-small[data-resize=1]').each(function(){
    ...
    $(document).ready(function(){
        ...
        catalogEcommerceV2Small.resizeVerticalBlock();

    });
    
    if (typeof BXReady.Market.loader != 'object')
            BXReady.Market.loader = [];
    BXReady.Market.loader.push(catalogEcommerceV2Small.resizeVerticalBlock);
    ...
    $(document).on("mouseover", ".bxr-ecommerce-v2-small .bxr-trade-request", function() {
        ...
        strParams = "";
        $(this).closest('.bxr-ecommerce-v2-small').find('li.bx_active').each(function() {

        ...
        addItem: function(form, delay, favor){
            ...
            if (!delay && !favor) {
                if ($('.bxr-bprop-required').length) {
                    $('.bxr-bprop-select-required').each(function() {
                        prop = $(this);
                ...
                if ($('.bxr-bprop-chb-required').length) {
                    $('.bxr-bprop-chb-required').each(function () {
                        prop = $(this);
                        container = prop.closest('.bxr-bprop-value');
                        pVal = prop.val();
                        pCode = prop.data("code");
                ...
                $('.bxr-bprop-select-optional').each(function() {
                    prop = $(this);
                    pVal = prop.val();
                    pCode = prop.data("code");
                    pName = prop.data("name");
                ...
                $('.bxr-bprop-chb-optional').each(function() {
                    prop = $(this);
                    pVal = ($(prop).is(":checked")) ? prop.val() : prop.val() + "_DESC_TYPE";
                    pCode = ($(prop).is(":checked")) ? prop.data("code") : prop.data("code") + "_DESC_TYPE";
                    pName = ($(prop).is(":checked")) ? prop.data("name") : prop.data("desc");
                    pSort = prop.data("sort");
                    if (pName.length)
                        bProp["BASKET_PROPS"][pCode] = {
                            NAME: encodeURIComponent(pName),
        ...
        basketButtonsInit: function(){
            ...
            $(document).on(
                ...
                function(){
                    ...
                    $('.bxr-quantity-text[data-item='+itemID+']').trigger("change");
                }
            );
